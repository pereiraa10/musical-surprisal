...
Version 1.1: 9 June 2021 - Giovanni M. Di Liberto
...
*** dataStim.mat: Information and data that is common across subjects (in the CND format)
 stim{1}.data: speech envelope vectors for each piece (organised in a cell array with 30 elements,
          one per experimental trial)
 stim{1}.fs: Envelope signal sampling frequency
 stim{2}.data: note onset vectors
 stim{3}.data: note onset modulated by the absolute pitch value.
